...
> **Примечание:** Для этого используется workflow-файл `.github/workflows/check_and_update_resume.yml`, который запускается по расписанию и проверяет необходимость обновления резюме.
